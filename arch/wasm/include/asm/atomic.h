...
#ifndef _ASM_WASM_ATOMIC_H
#define _ASM_WASM_ATOMIC_H
...
#define arch_atomic_fetch_add_relaxed(i, v)	__atomic_fetch_add(&((v)->counter), (i), __ATOMIC_RELAXED)
#define arch_atomic_add_return(i, v)		__atomic_add_fetch(&((v)->counter), (i), __ATOMIC_SEQ_CST)
#define arch_atomic_add_return_relaxed(i, v)	__atomic_add_fetch(&((v)->counter), (i), __ATOMIC_RELAXED)
#define arch_atomic_add				arch_atomic_add_return

#define arch_atomic_fetch_sub(i, v)		__atomic_fetch_sub(&((v)->counter), (i), __ATOMIC_SEQ_CST)
#define arch_atomic_fetch_sub_relaxed(i, v)	__atomic_fetch_sub(&((v)->counter), (i), __ATOMIC_RELAXED)
#define arch_atomic_sub_return(i, v)		__atomic_sub_fetch(&((v)->counter), (i), __ATOMIC_SEQ_CST)
#define arch_atomic_sub_return_relaxed(i, v)	__atomic_sub_fetch(&((v)->counter), (i), __ATOMIC_RELAXED)
#define arch_atomic_sub				arch_atomic_sub_return

#define arch_atomic_fetch_and(i, v)		__atomic_fetch_and(&((v)->counter), (i), __ATOMIC_SEQ_CST)
#define arch_atomic_fetch_and_relaxed(i, v)	__atomic_fetch_and(&((v)->counter), (i), __ATOMIC_RELAXED)
...
#define arch_atomic_fetch_or_relaxed(i, v)	__atomic_fetch_or(&((v)->counter), (i), __ATOMIC_RELAXED)
...
#define arch_atomic_fetch_xor_relaxed(i, v)	__atomic_fetch_xor(&((v)->counter), (i), __ATOMIC_RELAXED)
...
#define arch_atomic64_fetch_add_relaxed(i, v)	__atomic_fetch_add(&((v)->counter), (i), __ATOMIC_RELAXED)
#define arch_atomic64_add_return(i, v)		__atomic_add_fetch(&((v)->counter), (i), __ATOMIC_SEQ_CST)
#define arch_atomic64_add_return_relaxed(i, v)	__atomic_add_fetch(&((v)->counter), (i), __ATOMIC_RELAXED)
#define arch_atomic64_add			arch_atomic64_add_return

#define arch_atomic64_fetch_sub(i, v)		__atomic_fetch_sub(&((v)->counter), (i), __ATOMIC_SEQ_CST)
#define arch_atomic64_fetch_sub_relaxed(i, v)	__atomic_fetch_sub(&((v)->counter), (i), __ATOMIC_RELAXED)
#define arch_atomic64_sub_return(i, v)		__atomic_sub_fetch(&((v)->counter), (i), __ATOMIC_SEQ_CST)
#define arch_atomic64_sub_return_relaxed(i, v)	__atomic_sub_fetch(&((v)->counter), (i), __ATOMIC_RELAXED)
#define arch_atomic64_sub			arch_atomic64_sub_return

#define arch_atomic64_fetch_and(i, v)		__atomic_fetch_and(&((v)->counter), (i), __ATOMIC_SEQ_CST)
#define arch_atomic64_fetch_and_relaxed(i, v)	__atomic_fetch_and(&((v)->counter), (i), __ATOMIC_RELAXED)
...
#define arch_atomic64_fetch_or_relaxed(i, v)	__atomic_fetch_or(&((v)->counter), (i), __ATOMIC_RELAXED)
...
#define arch_atomic64_fetch_xor_relaxed(i, v)	__atomic_fetch_xor(&((v)->counter), (i), __ATOMIC_RELAXED)
#define arch_atomic64_xor(i, v)			__atomic_xor_fetch(&((v)->counter), (i), __ATOMIC_SEQ_CST)

#endif /* _ASM_WASM_ATOMIC_H */
